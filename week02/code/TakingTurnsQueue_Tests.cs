...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Check that it is added at the end
    ...
    // Defect(s) Found: Verify how the addition has been performed
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Check when there are infinite turns and there is no code to control it 0
    ...
    // Defect(s) Found: Check when there are infinite turns and there is no code to control it -3
    ...
    // Defect(s) Found: Check in case no people have been added
